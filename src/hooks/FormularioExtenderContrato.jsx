...
export const FormularioExtenderContrato = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const respuesta = await fetch(`http://192.168.1.202:5000/contrato/extender/${contrato.id}`, {
        method: 'POST',
        headers: {
      ...
      const respuestaFile = await fetch(`http://192.168.1.202:5000/documento/guardar`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
